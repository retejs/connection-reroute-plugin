...
function getPinsStorage() {
  ...
  return {
    add: function add(connectionId, pin, index) {
      ...
      var list = _toConsumableArray__default["default"](connectionPins.get(connectionId) || []);
...
var ReroutePlugin = /*#__PURE__*/function (_Scope) {
  _inherits__default["default"](ReroutePlugin, _Scope);
  var _super = _createSuper(ReroutePlugin);
  function ReroutePlugin() {
    var _this;
    _classCallCheck__default["default"](this, ReroutePlugin);
    _this = _super.call(this, 'connection-reroute');
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "pinContainers", new Map());
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "pinParents", new Map());
    _defineProperty__default["default"](_assertThisInitialized__default["default"](_this), "pins", getPinsStorage());
    return _this;
  }
  _createClass__default["default"](ReroutePlugin, [{
    key: "setParent",
    value: function setParent(scope) {
      var _this2 = this;
      _get__default["default"](_getPrototypeOf__default["default"](ReroutePlugin.prototype), "setParent", this).call(this, scope);
      // eslint-disable-next-line max-statements, complexity
      scope.addPipe(function (context) {
        ...
        if (context.type === 'rendered' && context.data.type === 'connection') {
          var area = scope.parentScope(reteAreaPlugin.BaseAreaPlugin);
          var _context$data = context.data,
        ...
        if (context.type === 'unmount') {
          var _area = scope.parentScope(reteAreaPlugin.BaseAreaPlugin);
        ...
        if (context.type === 'reordered') {
          var _area2 = scope.parentScope(reteAreaPlugin.BaseAreaPlugin);
        ...
        if (context.type === 'connectionpath') {
          var _area3 = scope.parentScope(reteAreaPlugin.BaseAreaPlugin);
          ...
          var points = [start].concat(_toConsumableArray__default["default"](pins.map(function (item) {
          ...
          for (var i = 1; i < points.length; i++) {
            var a = points[i - 1];
            var b = points[i];
            path += reteRenderUtils.classicConnectionPath([a, b], 0.3) + ' ';
          }
        ...
        if (context.type === 'pointerdown') {
          var _area4 = scope.parentScope(reteAreaPlugin.BaseAreaPlugin);
          ...
          if (pickedConnection) {
            var _pickedConnection = _slicedToArray__default["default"](pickedConnection, 2),
            ...
            if (svgPath && _pins) {
              ...
              var _points = [_start].concat(_toConsumableArray__default["default"](_pins.map(function (p) {
                return p.position;
              })), [_end]);
    ...
    value: function add(connectionId, position, index) {
      var area = this.parentScope().parentScope(reteAreaPlugin.BaseAreaPlugin);
      var pin = {
        id: rete.getUID(),
        position: position
      };
    ...
    key: "translate",
    value: function () {
      var _translate = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(pinId, dx, dy) {
        var pin;
    ...
    key: "remove",
    value: function () {
      var _remove = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(pinId) {
        var pin;
    ...
    key: "select",
    value: function () {
      var _select = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee3(pinId) {
        var pin;
    ...
    key: "unselect",
    value: function () {
      var _unselect = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee4(pinId) {
        var pin;
    ...
    value: function update(pin) {
      var pinRecord = _typeof__default["default"](pin) === 'object' ? pin : this.pins.getPin(pin);
      var area = this.parentScope().parentScope(reteAreaPlugin.BaseAreaPlugin);
      if (!pinRecord) return;
...
exports.RerouteExtensions = index;
exports.ReroutePlugin = ReroutePlugin;
//# sourceMappingURL=rete-connection-reroute-plugin.common.js.map
